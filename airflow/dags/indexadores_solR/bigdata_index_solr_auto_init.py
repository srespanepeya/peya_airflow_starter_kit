...
with DAG('BigData_Index_ReceptionEvent_Init_Solr_DAG', schedule_interval="*/3 * * * 1-7", catchup=False, default_args=default_args) as dag:
    
    ack = SSHOperator(
        task_id="write_index_solr_init",
        command="""
