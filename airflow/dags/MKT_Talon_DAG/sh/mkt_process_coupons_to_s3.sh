...
then
        ...
        /home/hduser/spark/bin/spark-submit --master spark://hadoop-namenode-ti:7077 --driver-memory 10G --driver-cores 8 --executor-memory 10G --conf spark.cores.max=8 /home/hduser/spark/apps/mkt_process_coupons_to_s3.py
        ...
        /home/hduser/spark/bin/spark-submit --master spark://hadoop-namenode-ti:7077 --driver-memory 10G --driver-cores 8 --executor-memory 10G --conf spark.cores.max=8 /home/hduser/spark/apps/mkt_process_coupons_to_s3.py -f $1
