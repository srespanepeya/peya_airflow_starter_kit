...
with DAG('BigData_Writer_Error_Solr_DAG', schedule_interval="*/2 * * * 1-7", catchup=False, default_args=default_args) as dag:
    write_index_solr_error = SSHOperator(
