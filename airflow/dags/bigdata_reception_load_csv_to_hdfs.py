...
with DAG('BigData_Reception_Solr_To_HDFS', schedule_interval="0 */1 * * *", catchup=False, default_args=default_args) as dag:
    ...
    extract_reception = SSHOperator(
        ...
        command="""
        /usr/bin/bash chmod 777 /home/hduser/spark/apps/airflow_scripts/reception/extract_event_to_csv.sh
        /usr/bin/bash chmod 777 /home/hduser/spark/apps/airflow_scripts/reception/extract_event_to_csv.py
    ...
    write_reception_hdfs = SSHOperator(
        ...
        python /home/hduser/spark/apps/airflow_scripts/reception/load_event_from_csv_to_hdfs.py -e reception
        """,
        timeout = 20,
        ssh_conn_id = "ssh_hadoop_namenode_ti"
    )
    ...
    begin_task >> [extract_reception] >> check_point_1 >> [write_reception_hdfs] >> check_point_2
