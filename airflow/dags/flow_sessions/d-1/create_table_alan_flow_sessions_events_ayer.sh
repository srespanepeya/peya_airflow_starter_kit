...
echo $f
echo "start create alan_flow_session_event hive"
/home/hduser/hive/bin/hive -v  --hiveconf particion=$f  -f /home/hduser/hive/scripts/create_table_alan_flow_sessions_event_peya.hql
echo "End create  alan_flow_session_event  hive"
